...
class screen():  #this new class doesnot inherate of any other class
    #create a class to model the screen of a kindle fire 
    def __init__(self,screen_resolution = '1200*800'):
        #Initialize the screen attributes
        self.screen_resolution = screen_resolution
    def describe_screen(self):
        #print out some marketing copy about kindle fire
        print("\nFire Hd 8 is a widescreen " + self.screen_resolution + " HD screen")
